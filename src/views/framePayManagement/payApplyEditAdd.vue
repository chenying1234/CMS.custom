<template>
  <el-form :model="formData" :rules="rules" ref="rulesForm" label-width="180px">
      ...
      <el-form-item label="供应商联系人电话：" prop="SupplierContactPhone">
          <el-input v-model="formData.SupplierContactPhone" placeholder="供应商联系人电话"></el-input>
      </el-form-item>
      <el-form-item label="供应商联系人Email：" prop="SupplierContactEmail">
          <el-input v-model="formData.SupplierContactEmail" placeholder="供应商联系人Email"></el-input>
      </el-form-item>
    ...
    getProjectedPayDL() {
      ...
      ExpectCostNameDDL({ ContractID: ContractID }).then(res => {
        if(res.data.flag) {
          ...
          if(pageFlag == 'edit') {
            this.editBtn = true;
            if(this.ProjectedPayDL.length != 0){
              this.getEditData();
            }
          }
        }
